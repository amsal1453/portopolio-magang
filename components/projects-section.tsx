...
const projects: Project[] = [
  {
    ...
    longDescription:
      "A comprehensive e-commerce solution built with React and Node.js, featuring user authentication, product management, shopping cart functionality, and secure payment processing with Stripe integration.",
  ...
  },
  {
    ...
    longDescription:
      "A modern task management application with drag-and-drop functionality, real-time collaboration, team management, and progress tracking. Built with React and Firebase for seamless real-time updates.",
  ...
  },
  {
    ...
    longDescription:
      "An elegant weather dashboard that provides detailed weather information, 7-day forecasts, and interactive maps. Features location-based weather detection and beautiful data visualizations.",
  ...
  },
  {
    ...
    longDescription:
      "A robust RESTful API built with Node.js and Express, featuring user authentication, post management, real-time messaging, and comprehensive documentation. Includes rate limiting and security best practices.",
  ...
  },
  {
    ...
    longDescription:
      "An innovative chat application that integrates AI-powered responses with real-time messaging. Features include smart replies, conversation history, and seamless user experience with modern UI design.",
    tech: ["React", "OpenAI API", "Socket.io", "Redis", "Docker"],
    image: "/placeholder.svg?height=400&width=600",
    liveUrl: "https://example.com",
    githubUrl: "https://github.com/user/repo",
    category: "Full Stack",
